...
class TestNode():
    ...
    def __init__(self, i, datadir_path, *, chain, rpchost, timewait, timeout_factor, bitcoinsilversilverd, bitcoinsilversilver_cli, coverage_dir, cwd, extra_conf=None, extra_args=None, use_cli=False, start_perf=False, use_valgrind=False, version=None, descriptors=False, v2transport=False):
        """
        Kwargs:
        ...
        self.cli = TestNodeCLI(bitcoinsilversilver_cli, self.datadir_path)
    ...
    def start(self, extra_args=None, *, cwd=None, stdout=None, stderr=None, env=None, **kwargs):
        ...
        # Add a new stdout and stderr file each time bitcoinsilversilverd is started
        if stderr is None:
...
class TestNodeCLI():
    ...
    def send_cli(self, clicommand=None, *args, **kwargs):
        """Run bitcoinsilversilver-cli command. Deserializes returned string as python object."""
