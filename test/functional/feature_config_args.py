#!/usr/bin/env python3
# Copyright (c) 2017-present The BitcoinSilver Core developers
...
from test_framework.test_framework import BitcoinSilverTestFramework
from test_framework.test_node import ErrorMatch
from test_framework import util


class ConfArgsTest(BitcoinSilverTestFramework):
    ...
    def test_dir_config(self):
        ...
        conf_path = self.nodes[0].datadir_path / 'bitcoinsilver.conf'
    ...
    def test_negated_config(self):
        ...
        ignored_file_message = [f'[InitConfig] Data directory "{self.nodes[0].datadir_path}" contains a "bitcoinsilver.conf" file which is explicitly ignored using -noconf.']
    ...
    def test_config_file_log(self):
        ...
        node = self.nodes[0]
        conf_text = node.bitcoinsilverconf.read_text()
        ...
        # (conf_path, not node.bitcoinsilverconf)
