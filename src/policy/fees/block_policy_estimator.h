...
#ifndef BITCOINSILVER_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
#define BITCOINSILVER_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
...
#endif // BITCOINSILVER_POLICY_FEES_BLOCK_POLICY_ESTIMATOR_H
