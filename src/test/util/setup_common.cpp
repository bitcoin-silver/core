...
constexpr inline auto TEST_DIR_PATH_ELEMENT{"test_common bitcoinsilver"}; // Includes a space to catch possible path escape issues.
    ...
    : TestingSetup{ChainType::REGTEST, opts}
{
...

    {
        ...
        assert(
            ...
            "62820fd0b70217790fb4d1cc22ae671914ec3058a8ca4062aeb270c33639165a");
    }
}
