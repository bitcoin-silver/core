...
const std::string EXAMPLE_ADDRESS[2] = {"bs1q09vm5lfy0j5reeulh4x5752q25uqqvz34hufdl", "bs1q02ad21edsxd23d32dfgqqsz4vv4nmtfzuklhy3"};
...
std::string HelpExampleRpcNamed(const std::string& methodname, const RPCArgList& args)
{
    ...
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"2.0\", \"id\": \"curltest\", "
           "\"method\": \"" + methodname + "\", \"params\": " + params.write() + "}' -H 'content-type: application/json' http://127.0.0.1:10567/\n";
}
