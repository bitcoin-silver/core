 ...
 */
const std::string UA_NAME("BitcoinSilver");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoin-silver/core>";

    //return CopyrightHolders(strprintf(_("Copyright (C) %i-%i"), 2009, COPYRIGHT_YEAR).translated + " ") + "\n" +
    return "\n" +
           (strprintf(_("Copyright (C) %i"), COPYRIGHT_YEAR).translated + " The Bitcoin Core Developers") + "\n" +
           +"\n" +
           (strprintf(_("Copyright (C) %i"), COPYRIGHT_YEAR).translated + " The BitcoinSilver Community") + "\n" +
           +"\n" +
