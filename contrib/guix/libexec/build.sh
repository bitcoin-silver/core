#!/usr/bin/env bash
# Copyright (c) 2019-present The BitcoinSilver developers
...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/bitcoinsilver-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/bitcoinsilver-macos-app.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
