...
```
$ python3 contrib/tracing/p2p_monitor.py $(pidof bitcoinsilverd)
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py $(pidof bitcoinsilverd)
```
...
```
$ ./build/bin/bitcoinsilverd -signet -reindex
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py $(pidof bitcoinsilverd)
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py $(pidof bitcoinsilverd)
```
