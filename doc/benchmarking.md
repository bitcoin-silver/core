...
---------------------
    ...
    build/bin/bench_bitcoinsilver -h
...
To monitor BitcoinSilver performance more in depth (like reindex or IBD): https://github.com/bitcoinsilver-dev-tools/benchcoin
