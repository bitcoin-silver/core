...
with "play bitcoinsilvers" on a test network.
...
```shell
$ valgrind --suppressions=test/sanitizer_suppressions/valgrind.supp build/bin/test_bitcoinsilver
$ valgrind --suppressions=test/sanitizer_suppressions/valgrind.supp --leak-check=full \
      --show-leak-kinds=all build/bin/test_bitcoinsilver --log_level=test_suite
$ valgrind -v --leak-check=full build/bin/bitcoinsilverd -printtoconsole
...
# A coverage report will now be accessible at `./build/test_bitcoinsilver.coverage/index.html`,
...
```shell
llvm-cov show \
    --object=build/bin/test_bitcoinsilver \
    --object=build/bin/bitcoinsilverd \
    ...
    --project-title="BitcoinSilver Coverage Report"
```
...
llvm-cov show \
    ...
    --show-expansions \
    --output-dir=build/coverage_report \
    --project-title="BitcoinSilver Fuzz Coverage Report"
```
...
- [Main thread (`bitcoinsilverd`)](https://doxygen.bitcoinsilvercore.org/bitcoinsilverd_8cpp.html#a0ddf1224851353fc92bfbff6f499fa97)
  : Started from `main()` in `bitcoinsilverd.cpp`. Responsible for starting up and
  shutting down the application.

- [Init load (`b-initload`)](https://doxygen.bitcoinsilvercore.org/namespacenode.html#ab4305679079866f0f420f7dbf278381d)
...
- [CCheckQueue::Loop (`b-scriptch.x`)](https://doxygen.bitcoinsilvercore.org/class_c_check_queue.html#a6e7fa51d3a25e7cb65446d4b50e6a987)
  : Parallel script validation threads for transactions in blocks.

- [ThreadHTTP (`b-http`)](https://doxygen.bitcoinsilvercore.org/httpserver_8cpp.html#abb9f6ea8819672bd9a62d3695070709c)
  : Libevent thread to listen for RPC and REST connections.

- [HTTP worker threads (`b-http_pool_x`)](https://doxygen.bitcoinsilvercore.org/httpserver_8cpp.html#a2ad0a49dc9b5e8117c0dee98c24187d8)
  : Threads to service RPC and REST requests.

- [Indexer threads (`b-txindex`, etc)](https://doxygen.bitcoinsilvercore.org/class_base_index.html#a96a7407421fbf877509248bbe64f8d87)
  : One thread per indexer.

- [SchedulerThread (`b-scheduler`)](https://doxygen.bitcoinsilvercore.org/class_c_scheduler.html#a14d2800815da93577858ea078aed1fba)
...
- [TorControlThread (`b-torcontrol`)](https://doxygen.bitcoinsilvercore.org/torcontrol_8cpp.html#a52a3efff23634500bb42c6474f306091)
  : Libevent thread for tor connections.

- Net threads:

  - [ThreadMessageHandler (`b-msghand`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#aacdbb7148575a31bb33bc345e2bf22a9)
  ...
  - [ThreadDNSAddressSeed (`b-dnsseed`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#aa7c6970ed98a4a7bafbc071d24897d13)
    : Loads addresses of peers from the DNS.

  - ThreadMapPort (`b-mapport`)
    : Universal plug-and-play startup/shutdown.

  - [ThreadSocketHandler (`b-net`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#a765597cbfe99c083d8fa3d61bb464e34)
    : Sends/Receives data from peers on port 10566.

  - [ThreadOpenAddedConnections (`b-addcon`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#a0b787caf95e52a346a2b31a580d60a62)
    : Opens network connections to added nodes.

  - [ThreadOpenConnections (`b-opencon`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#a55e9feafc3bab78e5c9d408c207faa45)
    : Initiates new connections to peers.

  - [ThreadI2PAcceptIncoming (`b-i2paccept`)](https://doxygen.bitcoinsilvercore.org/class_c_connman.html#a57787b4f9ac847d24065fbb0dd6e70f8)
...
Normally, these are maintained by active developers of BitcoinSilver, in which case
...
The tool instructions also include a list of the subtrees managed by BitcoinSilver.

To fully verify or update a subtree, add it as a remote:

```sh
git remote add libmultiprocess https://github.com/bitcoinsilver-core/libmultiprocess.git
```
...
- src/leveldb
  - Upstream at https://github.com/google/leveldb ; maintained by Google. Open
    important PRs to the BitcoinSilver subtree to avoid delay.
