...
`bitcoinsilver node` or `bitcoinsilver gui` can also be substituted for `bitcoinsilverd`.
...
your address. To mitigate this, additionally bind the address of your Tor proxy:
    ...
    bitcoinsilverd ... -bind=127.0.0.1:10564=onion
...
and open port 10566 on your firewall (or use port mapping, i.e., `-natpmp`).
