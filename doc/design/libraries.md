...
| *libbitcoinsilver_consensus*   | Stable, backwards-compatible consensus functionality used by *libbitcoinsilver_node* and *libbitcoinsilver_wallet*. |
